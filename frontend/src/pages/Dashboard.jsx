  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Available Workspaces</h1>
        ...
        {workspaces.map((workspace) => (
          <div key={workspace._id} className="glass rounded-2xl p-6 hover:shadow-xl transition-shadow duration-300 border border-gray-100">
            ...
            <Link 
              ...
              className="block w-full text-center bg-gray-50 hover:bg-brand-50 text-brand-600 font-medium py-2 rounded-lg border border-gray-200 hover:border-brand-200 transition-colors"
            >
              Select for Booking
            </Link>
          </div>
